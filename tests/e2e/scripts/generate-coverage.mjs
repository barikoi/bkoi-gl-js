...
const matrix = [
  ...
  ['Configuration — accessToken, style, center, zoom', ['map/basic']],
  ['Available styles — default and alternate style URLs', ['styles/setstyle']],
  ['Markers & Popups', ['marker-popup']],
  ...
  ['Camera Methods — events and payloads', ['events/contract']],
