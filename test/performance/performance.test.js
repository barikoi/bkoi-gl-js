...
describe('Performance Tests', () => {
  ...
  describe('Marker and Popup Performance', () => {
    ...
    test('should create markers efficiently', () => {
      ...
      const markers = []
      for (let i = 0; i < 50; i++) {
        const marker = global.bkoiTestUtils
          .createMockMarker()
    ...
    test('should create popups efficiently', () => {
      ...
      const popups = []
      for (let i = 0; i < 25; i++) {
        const popup = global.bkoiTestUtils
          .createMockPopup()
          .setLngLat([90.4125 + i * 0.01, 23.8103 + i * 0.01])
  ...
  describe('Memory Usage Tests', () => {
    test('should not have excessive memory growth with repeated operations', () => {
      ...
      console.log(
        `Memory stress test - avg time per operation: ${avgTimePerOperation.toFixed(2)}ms`
      )
    })
  ...
  describe('Concurrent Operations Performance', () => {
    ...
    test('should maintain performance under load', () => {
      ...
      for (let i = 0; i < 20; i++) {
        ...
        const popup = global.bkoiTestUtils.createMockPopup().setHTML(`<div>Load Test ${i}</div>`)
        const marker = global.bkoiTestUtils
          .createMockMarker()
          .setLngLat([90.4125 + i * 0.01, 23.8103 + i * 0.01])
          .setPopup(popup)
