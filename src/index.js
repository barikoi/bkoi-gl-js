 ...
 * @class BkoiGlMap
 * @extends {maplibre.Map}
 */
class BkoiGlMap extends Map {
    /**
   * Creates a new BkoiGlMap instance
   * @param {import('maplibre-gl').MapOptions & {accessToken?: string, polygon?: boolean, drawOptions?: object, styles?: Array<{style: string, image: string, name: string}>}} mapOptions - Map configuration options
   */
   ...
   * @private
   * @internal
   * @param {object} drawOptions - Drawing options
   */
   ...
   * @private
   * @internal
   * @param {Array<{style: string, image: string, name: string}>} styles - Array of style configurations
   */
